...
import PlanejamentoDashboard from "./modules/planejamento/PlanejamentoDashboard";
import PlanejamentoEAP from "./modules/planejamento/PlanejamentoEAP";
import PlanejamentoMedicoes from "./modules/planejamento/PlanejamentoMedicoes";
import PlanejamentoAcompanhamento from "./modules/planejamento/PlanejamentoAcompanhamento";
import PlanejamentoConfiguracoes from "./modules/planejamento/PlanejamentoConfiguracoes";
import PlanejamentoRelatorios from "./modules/planejamento/PlanejamentoRelatorios";
import ComissionamentoApp from "./modules/comissionamento/ComissionamentoApp";
import BDIApp from "../NERO-BDI/BDIApp";
...
const pages = {
  ...
  comissionamento: { label: "Comissionamento", icon: ClipboardList },
  bdi: { label: "Cálculo do BDI", icon: Calculator },
  "planejamento-dashboard": { label: "Dashboard", icon: LayoutDashboard },
  "planejamento-eap": { label: "EAP", icon: Briefcase },
  "planejamento-medicoes": { label: "Medições", icon: Calendar },
  "planejamento-acompanhamento": { label: "Acompanhamento", icon: Search },
  "planejamento-config": { label: "Configurações", icon: Wrench },
  "planejamento-relatorios": { label: "Relatórios", icon: FileText },
};
...
const STOCK_CODE_CATALOG = [
  ...
  {
    "code": "ASV-006",
    "description": "Cola flex pu maxx construção 400g",
    "category": "🧴 Adesivos, Selantes e Vedações (ASV)",
    "prefix": "ASV"
  },
  {
  ...
  },
  {
    ...
    "category": "🪵 Drywall e Isolamento (DRY)",
    "prefix": "DRY"
  },
  {
    "code": "DRY-002",
  ...
  {
    "code": "DRY-012",
    "description": "Regulador Nivelador F530 Normat",
    "category": "🪵 Drywall e Isolamento (DRY)",
    "prefix": "DRY"
  },
  {
    "code": "ELE-001",
    "description": "Fio 1,5 mm²",
    "category": "⚡ Elétrica (ELE)",
    "prefix": "ELE"
  },
  {
    "code": "ELE-002",
    "description": "Fio 2,5 mm²",
    "category": "⚡ Elétrica (ELE)",
    "prefix": "ELE"
  },
  {
    "code": "ELE-003",
    "description": "Fio 4,0 mm²",
    "category": "⚡ Elétrica (ELE)",
    "prefix": "ELE"
  },
  {
    "code": "ELE-004",
    "description": "Fio 6,0 mm²",
    "category": "⚡ Elétrica (ELE)",
    "prefix": "ELE"
  },
  {
    "code": "ELE-005",
    "description": "Eletroduto 1” Laranja",
    "category": "⚡ Elétrica (ELE)",
    "prefix": "ELE"
  },
  {
    "code": "ELE-006",
    "description": "Eletroduto 3/4 Laranja",
    "category": "⚡ Elétrica (ELE)",
    "prefix": "ELE"
  },
  {
    "code": "ELE-007",
    "description": "Eletroduto 3/4 Preto",
    "category": "⚡ Elétrica (ELE)",
    "prefix": "ELE"
  },
  {
  ...
  {
    "code": "HID-004",
    "description": "Tubo de 32 mm Água fria",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-005",
    "description": "Tubo de 40 mm Água fria",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-006",
    "description": "T 40 mm Água fria",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-007",
    "description": "T de 32 mm Água fria",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-008",
    "description": "T 32 / 25 mm Água fria",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-009",
    "description": "Curva 32 mm Água fria",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-010",
    "description": "Redução de 32/25 mm Água fria",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-011",
    "description": "Joelho de 32 mm Água fria",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-012",
    "description": "Luva de 40 mm Água fria",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-013",
    "description": "Luva de 32 mm Água fria",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-014",
    "description": "Tubo de 75 mm Esgoto",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-015",
    "description": "Joelho de 75 mm Esgoto",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-016",
    "description": "Redução 50/40 mm Esgoto",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-017",
    "description": "Luva de 50 mm Esgoto",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-018",
    "description": "Junção de 40 mm Esgoto",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-019",
    "description": "Junção de 50 mm Esgoto",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-020",
    "description": "Luva de 75 mm Esgoto",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-021",
    "description": "T de 50 mm Esgoto",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-022",
    "description": "Luva de 100 mm Esgoto",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-023",
    "description": "Joelho de 100 mm Esgoto",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-024",
    "description": "Curva de 100 mm Esgoto",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-025",
    "description": "Curva de 40 mm Esgoto",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
    "code": "HID-026",
    "description": "Curva de 75 mm Esgoto",
    "category": "🔧 Hidráulica (HID)",
    "prefix": "HID"
  },
  {
  ...
  },
  {
    ...
    "category": "Materiais de Construção (MCO)",
    "prefix": "MCO"
  },
  {
    "code": "MCO-002",
  ...
  },
  {
    ...
    "category": "🧱 Pisos, Revestimentos e Nivelamento (PRN)",
    "prefix": "PRN"
  },
  {
    "code": "PRN-002",
  ...
  {
    "code": "PRN-003",
    "description": "Eco painel Liso Click PL.31 Guelph 2800x600x900mm Interno",
    "category": "🧱 Pisos, Revestimentos e Nivelamento (PRN)",
    "prefix": "PRN"
  },
  {
  ...
  {
    "code": "PRN-008",
    "description": "Rejunte CZ Platina",
    "category": "🧱 Pisos, Revestimentos e Nivelamento (PRN)",
    "prefix": "PRN"
  },
  {
  ...
  },
  {
    ...
    "category": "🎨 Tintas e Complementos (TIN)",
    "prefix": "TIN"
  },
  {
    "code": "TIN-002",
...
const STOCK_CRITICAL_QUANTITY_RESTORE_MAP = {
  "FER-007": 425,
  "FER-008": 140,
  "FER-009": 108,
  "FER-010": 43,
...
const STOCK_CODE_CATALOG_BY_CODE = Object.fromEntries(
  (STOCK_CODE_CATALOG || []).map((entry) => [String(entry.code || "").trim().toUpperCase(), entry])
);
...
function stripLeadingCodeFromDescription(value) {
  return String(value || "").trim().replace(/^[A-Z]{2,3}-\d+\s*-?\s*/i, "").trim();
}

function normalizeBitolaLabel(value) {
  const raw = String(value || "").replace(/\s+/g, " ").trim();
  if (!raw) return "";
  const lower = raw.toLowerCase();

  if (/(1[\.,]?(?:50|5))\s*mm(?:²|2)?/.test(lower)) return "1,5 mm²";
  if (/(2[\.,]?(?:50|5))\s*mm(?:²|2)?/.test(lower)) return "2,5 mm²";
  if (/(4[\.,]?(?:00|0))\s*mm(?:²|2)?/.test(lower)) return "4,0 mm²";
  if (/(6[\.,]?(?:00|0))\s*mm(?:²|2)?/.test(lower)) return "6,0 mm²";
  if (/(10)\s*mm(?:²|2)?/.test(lower)) return "10 mm²";
  if (/(16)\s*mm(?:²|2)?/.test(lower)) return "16 mm²";
  if (/(25)\s*mm(?:²|2)?/.test(lower)) return "25 mm²";
  if (/(35)\s*mm(?:²|2)?/.test(lower)) return "35 mm²";
  if (/(50)\s*mm(?:²|2)?/.test(lower)) return "50 mm²";

  return raw;
}

function normalizeElectricalAlias(code, description) {
  const normalizedCode = String(code || "").trim().toUpperCase();
  ...
  if (/(cabo|fio)/.test(source)) {
    ...
    if (/(2[\.,]?(?:50|5))\s*mm(?:²|2)?/.test(source)) {
      return { code: "ELE-002", description: "Fio 2,5 mm²", category: "⚡ Elétrica (ELE)" };
    }
    if (/(4[\.,]?(?:00|0))\s*mm(?:²|2)?/.test(source)) {
      return { code: "ELE-003", description: "Fio 4,0 mm²", category: "⚡ Elétrica (ELE)" };
    }
    if (/(6[\.,]?(?:00|0))\s*mm(?:²|2)?/.test(source)) {
      return { code: "ELE-004", description: "Fio 6,0 mm²", category: "⚡ Elétrica (ELE)" };
    }
  }
...
function getStockCatalogEntry(query, catalog = STOCK_CODE_CATALOG) {
  ...
  return canonicalizeStockEntry(found.code, found.description, found.category);
}
...
function extractStockGroupCode(value) {
...
function stockRowMatchesSmartQuery(row, queryValue) {
  const raw = String(queryValue || "").trim();
  if (!raw) return true;

  const upper = raw.toUpperCase();
  const normalized = raw.toLowerCase();
  const parsed = parseStockItemLabel(row?.item || "");
  const code = String(row?.code || parsed.code || "").trim().toUpperCase();
  const rowGroupCode = getStockRowGroupCode(row);

  if (/^[A-Z]{3}$/.test(upper)) {
    return rowGroupCode === normalizeStockGroupAlias(upper);
  }

  if (/^[A-Z]{3}-\d{0,}$/.test(upper)) {
  ...
  if (baseHaystack.includes(normalized)) return true;

  if (normalized.length >= 4) {
    return String(row?.category || "").toLowerCase().includes(normalized);
  }
...
function getStockGroupFriendlyName(value) {
  const raw = String(value || "").trim();
  const clean = raw.replace(/^[^A-Za-z]+\s*/u, "");
  const withParen = clean.match(/^(.*?)\s*\(([A-Z]{3})\)$/);
  if (withParen) return String(withParen[1] || "").trim();
  const codeOnly = extractStockGroupCode(raw);
  if (codeOnly) {
    const aliases = {
      ELE: "Elétrica",
      HID: "Hidráulica",
      MCO: "Materiais de Construção",
...
function formatStockGroupOptionLabel(value) {
  const code = extractStockGroupCode(value);
  const name = getStockGroupFriendlyName(value);
  if (!code) return name || value;
  return `${code} - ${name}`;
}

function buildNextStockCode(prefix, sourceCodes = []) {
  const normalizedPrefix = normalizeStockGroupCode(prefix);
  if (!/^[A-Z]{3}$/.test(normalizedPrefix)) return "";
  const maxNumber = (sourceCodes || []).reduce((acc, codeValue) => {
    const code = String(codeValue || "").trim().toUpperCase();
    const match = code.match(new RegExp(`^${normalizedPrefix}-(\\d{1,})$`));
    if (!match) return acc;
...
function normalizeStoredAppData(stored) {
  if (!stored || typeof stored !== "object") return null;
  return repairCriticalStockQuantities(consolidateLegacyStockData(prepareNextDayData({
    ...initialData,
    ...stored,
    stock: (stored.stock || []).map((item) => normalizeLegacyStockItem(item)),
    stockCodeCatalog: (stored.stockCodeCatalog || []).map((entry) => normalizeLegacyStockCatalogEntry(entry)),
    stockResponsibles: (stored.stockResponsibles || []).map((item) => normalizeResponsibleName(item)).filter(Boolean),
...
function normalizeLegacyStockCatalogEntry(entry) {
  const canonical = canonicalizeStockEntry(entry?.code, entry?.description, entry?.category);
  return {
    code: String(canonical.code || "").trim().toUpperCase(),
    description: String(canonical.description || "").trim(),
    category: String(canonical.category || entry?.category || "Material").trim() || "Material",
  };
}
...
function repairCriticalStockQuantities(appData) {
  if (!appData || typeof appData !== "object") return appData;

  const stock = Array.isArray(appData.stock)
    ? appData.stock.map((item) => normalizeLegacyStockItem(item))
    : [];

  const movements = Array.isArray(appData.stockMovements) ? appData.stockMovements : [];
  const obras = Array.isArray(appData.obras) ? appData.obras : [];
  const targetObraId =
    stock.find((item) => item?.obraId)?.obraId ||
    obras.find((obra) => String(obra?.nome || "").toUpperCase().includes("REFORMA NOVA SEDE"))?.id ||
    obras[0]?.id ||
    null;
  ...
  for (const item of stock) {
    ...
    if (!code) continue;
    if (!stockByCode.has(code)) stockByCode.set(code, []);
    stockByCode.get(code).push(item);
  }

  for (const [code, restoredQuantity] of Object.entries(STOCK_CRITICAL_QUANTITY_RESTORE_MAP)) {
    const existingRows = stockByCode.get(code) || [];
    const catalogEntry = STOCK_CODE_CATALOG_BY_CODE[code] || {};
    const canonical = canonicalizeStockEntry(
      code,
      catalogEntry.description || existingRows[0]?.item || code,
      catalogEntry.category || existingRows[0]?.category || inferStockCategoryFromCode(code, "Material")
    );

    if (existingRows.length) {
      const primary = existingRows[0];
      const hasMovements = movements.some((mv) => sameId(mv?.itemId, primary.id));
      const currentBaseQuantity = Number(primary.quantity || 0);

      if (currentBaseQuantity <= 0 && !hasMovements) {
        primary.quantity = restoredQuantity;
      } else if (currentBaseQuantity <= 0 && hasMovements) {
        const currentBalance = calculateStockBalance(primary.id, movements, currentBaseQuantity);
        if (currentBalance <= 0) {
          primary.quantity = restoredQuantity;
        }
      }

      primary.item = buildStockItemLabel(canonical.code, canonical.description);
      primary.category = getCanonicalStockGroupLabel(
        extractStockGroupCode(canonical.category || canonical.code),
        canonical.category || primary.category || "Material"
      );
      primary.unit = primary.unit || "un";
      primary.min = Number(primary.min || 0);
      primary.price = Number(primary.price || 0);

      continue;
    }

    stock.push({
      id: `restore-${code}-${Date.now()}`,
      obraId: targetObraId,
      item: buildStockItemLabel(canonical.code, canonical.description),
      unit: "un",
      quantity: restoredQuantity,
      min: 0,
      category: getCanonicalStockGroupLabel(
        extractStockGroupCode(canonical.category || canonical.code),
        canonical.category || catalogEntry.category || "Material"
      ) || canonical.category || catalogEntry.category || "Material",
      invoice: "",
      price: 0,
...
function consolidateLegacyStockData(appData) {
  const rawStock = (appData?.stock || []).map((item) => normalizeLegacyStockItem(item));
  const rawMovements = [...(appData?.stockMovements || [])];
  ...
  for (const item of rawStock) {
    ...
    legacyToCanonicalId.set(String(item.id), canonicalItem.id);
  }

  const stock = Array.from(grouped.values());
  const stockMovements = rawMovements.map((mv) => ({
    ...mv,
    itemId: legacyToCanonicalId.get(String(mv?.itemId)) || mv?.itemId,
  }));
...
function createPersistableAppData(appData) {
  const normalizedSource = repairCriticalStockQuantities(consolidateLegacyStockData(appData));
  const normalizedStock = (normalizedSource.stock || []).map((item) => normalizeLegacyStockItem(item));
  const normalizedCatalog = [
    ...STOCK_CODE_CATALOG,
    ...(normalizedSource.stockCodeCatalog || []),
  ].map((entry) => normalizeLegacyStockCatalogEntry(entry));
  ...
  return {
    ...
    stockCategories: Array.from(new Set(
      [
        "Material",
        ...(appData.stockCategories || []),
        ...normalizedStock.map((item) => item.category),
        ...normalizedCatalog.map((entry) => entry.category),
      ]
    ...
    stockResponsibles: Array.from(new Set(
      [
        ...
        ...(normalizedSource.stockMovements || []).map((mv) => normalizeResponsibleName(mv?.responsible)),
      ].filter(Boolean)
...
function Modal({ open, title, children, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-6xl rounded-[30px] border border-slate-200 bg-white shadow-2xl max-h-[92vh] overflow-auto">
...
function LogoBlock() {
  return (
    <div className="flex items-center gap-4">
      <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-[20px] bg-white p-2 shadow-md ring-1 ring-white/40">
        <img
          src={LOGO_BASE64 || "/logo-nero.png"}
          alt="NERO Construções"
          className="h-full w-full object-contain"
          onError={(e) => {
            e.currentTarget.src = "/logo-nero.png";
          }}
        />
      </div>

      <div className="min-w-0">
        <p className="text-[9px] uppercase tracking-[0.20em] text-green-200">
          Sistema Web
        </p>
        <h1 className="mt-2 text-[1.18rem] font-extrabold tracking-tight text-white leading-none uppercase">
          NERO
        </h1>
        <h2 className="mt-1 text-[1.02rem] font-extrabold tracking-tight text-white leading-none uppercase">
          CONSTRUÇÕES
        </h2>
      </div>
    </div>
...
function Sidebar({ currentPage, setCurrentPage }) {
  ...
  const sidebarPages = ["dashboard", "stock", "diarias", "maintenance", "attendance", "history", "comissionamento", "bdi"];
  const planejamentoPages = [
    "planejamento-dashboard",
    "planejamento-eap",
    "planejamento-medicoes",
    "planejamento-acompanhamento",
    "planejamento-config",
    "planejamento-relatorios",
  ];
  const planejamentoActive = planejamentoPages.includes(currentPage);
...
function Topbar({
  ...
  const mobilePages = ["dashboard", "stock", "diarias", "maintenance", "attendance", "history", "comissionamento", "bdi"];
  const planejamentoMobilePages = ["planejamento-dashboard", "planejamento-eap", "planejamento-medicoes", "planejamento-acompanhamento", "planejamento-config", "planejamento-relatorios"];
  return (
    <div className="sticky top-0 z-20 bg-white/95 backdrop-blur-md border-b border-slate-200/80 shadow-[0_4px_24px_rgba(15,23,42,0.04)]">
      <div className="px-5 md:px-8 py-4 flex flex-col gap-4">
        ...
        <div className="md:hidden space-y-3">
          ...
          <div>
            <p className="mb-2 text-xs font-semibold uppercase tracking-[0.18em] text-slate-400">Planejamento</p>
            <div className="grid grid-cols-2 gap-2">
              {planejamentoMobilePages.map((page) => (
                <button
                  key={page}
                  onClick={() => setCurrentPage(page)}
                  className={cn(
                    "h-10 rounded-xl border text-sm font-medium transition-colors",
                    currentPage === page ? "bg-emerald-900 text-white border-emerald-900" : "bg-white text-slate-700 border-slate-200 hover:bg-slate-50 hover:border-slate-300"
                  )}
                >
                  {pages[page].label}
                </button>
  ...
  return (
    <div className="space-y-5">
      ...
      <Card className="overflow-hidden shadow-[0_12px_40px_rgba(15,23,42,0.06)]">
        <div className="p-5 md:p-7 bg-white text-slate-900">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4">
        ...
        <QuickActionCard icon={ClipboardList} title="Comissionamento" subtitle="Checklist, pendências, SLA e evidências" onClick={onGoToComissionamento} />
      </section>
    </div>
  );
}
...
function StockPage({ stock, stockMovements, hiddenStockGroupPrefixes = [], onBack, onAdd, onDelete, onMove, onView, onEdit, onEditMovement, onDeleteMovement, onOpenHeaderView, onOpenHeaderEdit, onOpenGroupEdit, onExportMovements, onExportStockPosition, onRunLegacyCleanup, onRegularizeInitialStock, cleanupFeedback = "" }) {
  ...
  const filteredDisplayItems = useMemo(() => {
    ...
    return stockBalanceRows.filter((item) => {
      ...
      const matchesQuery = stockRowMatchesSmartQuery(item, cardQuery);
      return matchesCategory && matchesQuery;
    });
  }, [stockBalanceRows, cardQuery, cardCategory]);

  const lowStockItems = useMemo(
    () => stockBalanceRows.filter((item) => Number(item.saldo) < Number(item.min)).sort((a, b) => (Number(b.min || 0) - Number(b.saldo || 0)) - (Number(a.min || 0) - Number(a.saldo || 0))),
    [stockBalanceRows]
  );
    ...
    return [...(stockMovements || [])]
      ...
      .filter((row) => {
        ...
        const matchesQuery = !query
          || stockRowMatchesSmartQuery(row, movementsReportQuery)
  ...
  }, [reportCategory, reportQuery, stockBalanceRows]);

  const consumptionRows = useMemo(() => {
    const startDate = String(consumptionRange.start || "");
    const endDate = String(consumptionRange.end || "");
    const grouped = new Map();
    ...
    (stockMovements || [])
      ...
      .forEach((mv) => {
        ...
        if (!grouped.has(key)) {
          grouped.set(key, {
            code: canonical.code || "-",
            material: canonical.description || item.item || "-",
            category: canonical.category || item.category || "Material",
            quantity: 0,
            movements: 0,
            lastResponsible: normalizeResponsibleName(mv.responsible) || "-",
          });
        }
        const current = grouped.get(key);
        current.quantity += Number(mv.quantity || 0);
        current.movements += 1;
        if (normalizeResponsibleName(mv.responsible)) current.lastResponsible = normalizeResponsibleName(mv.responsible);
      });

    return Array.from(grouped.values()).sort((a, b) => String(a.code || "").localeCompare(String(b.code || ""), "pt-BR", { numeric: true, sensitivity: "base" }));
  }, [stockMovements, stock, consumptionRange]);
  ...
  return (
    <div className="space-y-5">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <HomeStatCard title="Estoque baixo" value={lowStockItems.length} subtitle="Itens abaixo do mínimo" icon={AlertTriangle} alert={lowStockItems.length > 0} tone={lowStockItems.length > 0 ? "danger" : "default"} />
        <HomeStatCard title="Categorias" value={categories.length - 1} subtitle="Grupos disponíveis para cadastro" icon={LayoutDashboard} />
        <HomeStatCard title="Movimentações" value={movementCount} subtitle={`Saldo físico consolidado: ${totalUnits}`} icon={FileText} tone="success" />
      </section>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1.5fr_1fr] gap-4">
          ...
          <div className="p-5 space-y-4">
            <div className="stock-search-header flex flex-col gap-4 xl:grid xl:grid-cols-[minmax(520px,1fr)_auto] xl:items-end">
              ...
              <div className="stock-search-controls flex flex-col sm:flex-row gap-2 xl:items-center">
                ...
                <select value={cardCategory} onChange={(e) => setCardCategory(e.target.value)} className="h-11 rounded-2xl border border-slate-200 bg-white px-3 text-sm text-slate-700 outline-none">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-4">
              {filteredDisplayItems.length ? filteredDisplayItems.map((item) => {
                const itemMovements = (stockMovements || []).filter((mv) => (item.itemIds || []).some((id) => sameId(mv.itemId, id)));
                const isLow = Number(item.saldo) < Number(item.min);
                return (
                  <Card key={item.code || item.id} className="border border-slate-200 shadow-sm">
                    <div className="p-4 space-y-3.5">
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0 pr-2">
                          <div className="flex flex-wrap items-center gap-2">
                            <p className="text-sm text-slate-500">{item.category}</p>
                            {item.code ? <Badge className="bg-emerald-50 text-emerald-800 border-emerald-200">{item.code}</Badge> : null}
                            {Number(item.sourceCount || 1) > 1 ? <Badge className="bg-sky-50 text-sky-800 border-sky-200">Consolidado</Badge> : null}
                          </div>
                          <h3 className="text-[15px] font-semibold text-slate-900 mt-1 break-words">{item.material}</h3>
                        </div>
                        <Badge className={isLow ? "bg-rose-100 text-rose-700 border-rose-200" : "bg-slate-100 text-slate-700 border-slate-200"}>{isLow ? "Mínimo" : "Normal"}</Badge>
                      </div>
                ...
                <div className="lg:col-span-2 2xl:col-span-3 rounded-2xl border border-dashed border-slate-300 bg-slate-50 px-4 py-8 text-center text-slate-500">
        ...
        <Card>
          <div className="p-5 space-y-4">
            <div>
              <p className="text-sm font-semibold tracking-wide text-amber-700 uppercase">Painel de compras</p>
              <h3 className="text-2xl font-bold text-slate-900">Itens abaixo do mínimo</h3>
              <p className="text-sm text-slate-500">Lista priorizada para reposição da obra atual.</p>
            </div>
            <div className="space-y-3">
              {lowStockItems.length ? lowStockItems.map((item) => (
                <div key={`low-${item.code}`} className="rounded-2xl border border-amber-200 bg-amber-50/60 px-4 py-3">
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      <div className="flex flex-wrap items-center gap-2">
                        <Badge className="bg-white text-amber-800 border-amber-300">{item.code}</Badge>
                        <span className="text-xs uppercase tracking-[0.08em] text-amber-700">{item.category}</span>
                      </div>
                      <p className="mt-2 font-semibold text-slate-900">{item.material}</p>
                    </div>
                  ...
                  <div className="mt-3 grid grid-cols-2 gap-3 text-sm">
                    <div className="rounded-xl bg-white px-3 py-2 border border-amber-100">
                      ...
                      <p className="font-semibold text-slate-900">{item.saldo} {item.unit}</p>
                    </div>
                    <div className="rounded-xl bg-white px-3 py-2 border border-amber-100">
                      <p className="text-slate-500">Mínimo</p>
                      <p className="font-semibold text-slate-900">{item.min} {item.unit}</p>
                    </div>
                  </div>
                </div>
              )) : (
                <div className="rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-6 text-center text-emerald-900">
                  Nenhum item abaixo do mínimo na obra atual.
                </div>
              )}
            </div>
          </div>
        ...
        <div className="space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Field label="Data inicial">
              <Input type="date" value={consumptionRange.start} onChange={(e) => setConsumptionRange((prev) => ({ ...prev, start: e.target.value }))} />
            </Field>
            <Field label="Data final">
              <Input type="date" value={consumptionRange.end} onChange={(e) => setConsumptionRange((prev) => ({ ...prev, end: e.target.value }))} />
            </Field>
          </div>
          <div className="overflow-x-auto rounded-2xl border border-slate-200 bg-white">
            <table className="min-w-full text-sm">
              ...
              <tbody>
                {consumptionRows.length ? consumptionRows.map((row, index) => (
                  <tr key={`${row.code}-${index}`} className={index % 2 === 0 ? "bg-white" : "bg-slate-50"}>
                    <td className="border-t border-slate-200 px-4 py-3 text-center font-medium text-slate-700">{row.code}</td>
                    <td className="border-t border-slate-200 px-4 py-3 text-slate-800">{row.material}</td>
                    <td className="border-t border-slate-200 px-4 py-3 text-slate-700">{row.category}</td>
                    <td className="border-t border-slate-200 px-4 py-3 text-center font-semibold text-slate-900">{row.quantity}</td>
                    <td className="border-t border-slate-200 px-4 py-3 text-center text-slate-700">{row.movements}</td>
                    <td className="border-t border-slate-200 px-4 py-3 text-slate-700">{row.lastResponsible}</td>
                  </tr>
                )) : (
                  <tr>
                    <td colSpan={6} className="px-4 py-6 text-center text-slate-500">Nenhum consumo encontrado no período selecionado.</td>
                  </tr>
                )}
              </tbody>
            </table>
          ...
          <div className="flex justify-end gap-3">
            <Button variant="outline" onClick={() => setConsumptionModalOpen(false)}>Fechar</Button>
          </div>
        </div>
      </Modal>
    </div>
      ...
      <div className="space-y-5">
        {grouped.map(({ company, rows, total }) => (
          <Card key={company.id} className="overflow-hidden shadow-[0_8px_28px_rgba(15,23,42,0.04)]">
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 p-5 md:p-7 border-b border-slate-100">
              <div>
...
function buildStockBalanceRows(stockItems = [], stockMovements = [], catalogEntries = STOCK_CODE_CATALOG, hiddenGroupPrefixes = []) {
  ...
  for (const catalogEntry of catalogEntries || []) {
    ...
    if (!grouped.has(key)) {
      grouped.set(key, {
        ...
        item: buildStockItemLabel(canonical.code, canonical.description),
        code: canonical.code || "-",
        material: canonical.description || catalogEntry.description || "-",
        entrada: 0,
        saida: 0,
        saldo: 0,
        quantity: 0,
  ...
  const rows = Array.from(grouped.values()).map((row) => {
    ...
    const restoredQuantity = STOCK_CRITICAL_QUANTITY_RESTORE_MAP[code];

    if (restoredQuantity !== undefined && Number(row.saldo || 0) <= 0) {
      return {
        ...row,
        saldo: restoredQuantity,
        quantity: restoredQuantity,
        isRestoredCriticalStock: true,
      };
    }
...
async function exportStockBalancePdf(stockItems, stockMovements, obraAtual, selectedAreaLabel = "Almoxarifado", options = {}) {
  ...
  const rows = buildStockBalanceRows(stockItems, stockMovements).filter((row) => {
    ...
    const matchesQuery = !exportQuery || stockRowMatchesSmartQuery(row, options?.query || "");
    return matchesCategory && matchesQuery;
  });
  ...
  return (
    <div className="space-y-5">
      <Card className="overflow-hidden">
        ...
        <div className="p-5 bg-white max-w-xl">
...
function DiariasPageIntegrada({ onBack, obraAtual }) {
  ...
  async function recarregarBase(preferSemanaId = "") {
    ...
    setError("");
    try {
      const [cargosData, semanasData, nomesData] = await Promise.all([diariasLoadCargos(), diariasLoadSemanas(), diariasLoadNomesCadastrados()]);
  ...
  const nomesOptions = useMemo(() => {
    return (nomesCadastrados || []).map((item) => ({
    ...
    return (
      <div className="space-y-5">
        <Card className="overflow-hidden">
          ...
          <div className="p-5 bg-white text-sm text-slate-600">Configure o Supabase para usar o módulo de Diárias com login restrito.</div>
        </Card>
      </div>
    );
  }
    ...
    return (
      <div className="space-y-5">
        <Card className="overflow-hidden">
          ...
          <div className="p-5 bg-white text-sm text-slate-600">Carregando autenticação do módulo.</div>
        </Card>
      </div>
    );
  }
        ...
        <>
          <div className="grid grid-cols-1 xl:grid-cols-[1.05fr_0.95fr] gap-5">
            <Card className="overflow-hidden">
              ...
              <div className="p-5 space-y-5 bg-white">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Field label="Semana de"><Input type="date" value={form.semanaInicio} onChange={(e) => setForm((prev) => ({ ...prev, semanaInicio: e.target.value }))} disabled={saving} /></Field>
                  <Field label="Até"><Input type="date" value={form.semanaFim} onChange={(e) => setForm((prev) => ({ ...prev, semanaFim: e.target.value }))} disabled={saving} /></Field>
                </div>
            ...
            <Card className="overflow-hidden">
              ...
              <div className="p-5 space-y-3 bg-white">
                ...
                {!loading && !semanas.length ? <div className="rounded-2xl border border-dashed border-slate-300 p-5 text-sm text-slate-500 text-center">Nenhuma semana cadastrada.</div> : null}
                {semanas.map((item) => {
          ...
          <Card className="overflow-hidden">
            ...
            <div className="p-5 space-y-3 bg-white">
              ...
              {!listaFiltrada.length ? <div className="rounded-2xl border border-dashed border-slate-300 p-5 text-sm text-slate-500 text-center">Nenhum lançamento cadastrado ainda.</div> : null}
            </div>
          </Card>
        </>
      ) : (
...
export default function App() {
  ...
  const [stockConsumptionRange, setStockConsumptionRange] = useState({ start: getTodayISO().slice(0, 8) + "01", end: getTodayISO() });
  ...
  const stockResponsibleOptions = useMemo(() => {
    return Array.from(new Set([
      ...(data.stockResponsibles || []),
      ...((filteredData.stockMovements || []).map((mv) => normalizeResponsibleName(mv?.responsible))),
        ...
        [
          ...
          ...((data.stock || []).map((item) => {
            ...
            return {
              code: String(parsed.code || "").trim().toUpperCase(),
              description: String(parsed.description || item?.item || "").trim(),
              category: String(parsed.category || item?.category || "").trim() || "Material",
            };
          })),
        ]
          .map((entry) => {
            const canonical = canonicalizeStockEntry(entry?.code, entry?.description, entry?.category);
            const code = String(canonical?.code || "").trim().toUpperCase();
            const description = String(canonical?.description || "").trim();
            const category = String(canonical?.category || "").trim() || "Material";
            return [code || `${description}::${category}`, { code, description, category }];
          })
      ).values()
    )
  ...
  const stockAllKnownCodes = useMemo(() => {
    return Array.from(
      new Set(
        [
          ...stockCatalogEntries.map((entry) => String(entry?.code || "").trim().toUpperCase()),
          ...((data.stock || []).map((item) => String(parseStockItemLabel(item?.item)?.code || "").trim().toUpperCase())),
          ...((data.stockCodeCatalog || []).map((entry) => String(canonicalizeStockEntry(entry?.code, entry?.description, entry?.category)?.code || "").trim().toUpperCase())),
        ].filter(Boolean)
      )
    );
  }, [stockCatalogEntries, data.stock, data.stockCodeCatalog]);

  function getSuggestedStockCode(categoryValue) {
    const prefix = extractStockGroupCode(categoryValue);
    if (!/^[A-Z]{3}$/.test(prefix)) return "";
    return buildNextStockCode(prefix, stockAllKnownCodes);
  }
  ...
  const stockPickerResults = useMemo(() => {
    ...
    return source.filter((item) => stockRowMatchesSmartQuery(item, stockPickerQuery));
  }, [filteredData.stock, filteredData.stockMovements, stockPickerQuery]);
  ...
  async function fetchAllData() {
    ...
    try {
      ...
      const repairedMergedData = repairCriticalStockQuantities(mergedData);
      setData(persistAppSnapshot(repairedMergedData));
      setObraId((current) => {
  ...
  function openStockMovementEditor(movement) {
    ...
    setStockMovementEditModal(true);
  }

  async function saveStockMovementEdit() {
    if (!editingStockMovementId) {
  ...
  function addStockCategory() {
    ...
    if (!normalized) {
      setErrorMessage("Digite o código do grupo com 3 letras.");
      return;
    }
    if (!/^[A-Z]{3}$/.test(normalized)) {
      setErrorMessage("O grupo deve ter exatamente 3 letras, como ELE, HID ou MCO.");
      return;
    }
    const alreadyExists = stockCategoryOptions.some((item) => extractStockGroupCode(item) === normalized);
    if (alreadyExists) {
      setErrorMessage("Esse grupo já existe no sistema.");
      return;
    }
    commitDataUpdate((prev) => ({
      ...prev,
  ...
  function addStockCode() {
    ...
    if (!/^[A-Z]{2,3}-\d{3}$/.test(normalizedCode)) {
      setStockCodeFeedback("O código deve seguir o padrão AAA-000.");
      setTimeout(() => setStockCodeFeedback(""), 3000);
      return;
    }
    ...
    const canonical = canonicalizeStockEntry(normalizedCode, normalizedDescription, normalizedCategory);
    const canonicalCode = String(canonical.code || "").trim().toUpperCase();
    const canonicalDescription = String(canonical.description || "").trim();
    const canonicalCategory = String(canonical.category || normalizedCategory).trim() || "Material";

    if (!/^[A-Z]{3}-\d{3}$/.test(canonicalCode)) {
      setStockCodeFeedback("O código legado foi bloqueado. Use somente o padrão novo AAA-000.");
      setTimeout(() => setStockCodeFeedback(""), 3000);
      return;
    }
    ...
    commitDataUpdate((prev) => ({
      ...
      stockCodeCatalog: Array.from(new Map([
        ...(prev.stockCodeCatalog || []),
        { code: canonicalCode, description: canonicalDescription, category: canonicalCategory },
      ].map((entry) => {
        const normalizedEntry = normalizeLegacyStockCatalogEntry(entry);
        return [String(normalizedEntry.code || "").trim().toUpperCase(), normalizedEntry];
      })).values()),
      stockCategories: Array.from(new Set([...(prev.stockCategories || []), canonicalCategory])).filter(Boolean),
    }));
    setStockForm((prev) => ({ ...prev, code: canonicalCode, item: canonicalDescription, category: canonicalCategory }));
    setStockCodeFeedback(canonicalCode !== normalizedCode ? `Código antigo convertido automaticamente para ${canonicalCode}.` : "");
  }
  ...
  async function runDefinitiveLegacyCleanup() {
    const cleaned = consolidateLegacyStockData(data);

    commitDataUpdate((prev) => ({
      ...prev,
      stock: cleaned.stock,
      stockMovements: cleaned.stockMovements,
      stockCodeCatalog: cleaned.stockCodeCatalog || prev.stockCodeCatalog || [],
      stockCategories: cleaned.stockCategories || prev.stockCategories || [],
    }));

    setLegacyCleanupFeedback("Limpeza definitiva aplicada: códigos antigos consolidados e vínculos remapeados.");
    setTimeout(() => setLegacyCleanupFeedback(""), 4000);
  }
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
            ...
            {loading ? (
              ...
              <AnimatePresence mode="wait">
                <motion.div key={currentPage} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} transition={{ duration: 0.22 }}>
                  ...
                  {currentPage === "planejamento-medicoes" && (
                  <PlanejamentoMedicoes obraId={obraAtual?.id} obraNome={obraAtual?.nome} />
                )}
                  {currentPage === "planejamento-acompanhamento" && (
                  <PlanejamentoAcompanhamento obraId={obraAtual?.id} obraNome={obraAtual?.nome} />
                )}
                  {currentPage === "planejamento-config" && (
                  <PlanejamentoConfiguracoes obraId={obraAtual?.id} obraNome={obraAtual?.nome} />
                )}
                  {currentPage === "planejamento-relatorios" && (
                  <PlanejamentoRelatorios obraId={obraAtual?.id} obraNome={obraAtual?.nome} />
                )}
                </motion.div>
              </AnimatePresence>
            )}
      ...
      <Modal open={stockModal || stockEditModal} title={stockEditModal ? "Editar material" : "Novo material"} onClose={() => { setStockModal(false); setStockEditModal(false); setEditingStockId(""); setEditingStockItemIds([]); setStockCodeFeedback(""); }}>
        <div className="space-y-5">
          <div className="rounded-[28px] border border-slate-200 bg-gradient-to-b from-white to-slate-50/70 p-5 shadow-sm">
            <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_300px] gap-5 items-start">
              <div className="space-y-5">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <p className="text-[30px] font-semibold tracking-tight text-slate-900">{stockEditModal ? "Editar material" : "Novo material"}</p>
                    <p className="mt-1.5 text-sm text-slate-500">Escolha o grupo, informe o código da tabela e finalize o cadastro com os dados operacionais.</p>
                  </div>
                  <div className="rounded-2xl border border-emerald-200 bg-emerald-50 px-3 py-2 text-right">
                    <p className="text-xs font-semibold uppercase tracking-[0.18em] text-emerald-700">Padrão</p>
                    <p className="mt-1 text-sm font-semibold text-emerald-900">AAA-000</p>
                  </div>
                </div>

                <div className="rounded-[24px] border border-slate-200 bg-white p-5 space-y-4 shadow-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-lg font-semibold text-emerald-800">Grupo</p>
                      <p className="text-sm text-slate-500">Use um grupo existente ou crie um novo com exatamente 3 letras.</p>
                    </div>
                  </div>

                  <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-4 items-end">
                    <Field label="Grupo">
                      <select
                        className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-slate-900 outline-none transition focus:border-emerald-300 focus:ring-4 focus:ring-emerald-50"
                    ...
                    <div className="grid grid-cols-[1fr_auto] gap-2 items-end">
                      <div>
                        <label className="mb-2 block text-sm font-medium text-slate-700">Criar novo grupo</label>
                        <Input placeholder="Ex.: MCO" value={stockNewCategory} onChange={(e) => setStockNewCategory(normalizeStockGroupCode(e.target.value))} maxLength={3} />
                      </div>
                      <Button type="button" variant="outline" className="border-emerald-300 text-emerald-800 hover:bg-emerald-50 h-[50px] px-5" onClick={addStockCategory}>Criar</Button>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-[24px] border border-slate-200 bg-white p-5 space-y-4 shadow-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-lg font-semibold text-emerald-800">Código do material</p>
                      <p className="text-sm text-slate-500">Digite o código conforme a tabela aprovada. A numeração automática está temporariamente desativada.</p>
                    </div>
                  </div>
                  ...
                  <Field label="Código do material">
                    <div className="relative">
                      <Input
                        ...
                        onChange={(e) => setStockForm((prev) => ({ ...prev, code: e.target.value.toUpperCase() }))}
                      />
                    </div>
                  </Field>

                  {stockCodeFeedback ? <p className="text-sm text-rose-600">{stockCodeFeedback}</p> : null}
                </div>

                <div className="rounded-[24px] border border-slate-200 bg-white p-5 space-y-4 shadow-sm">
                  <div className="flex items-center gap-3">
                    <span className="flex h-8 w-8 items-center justify-center rounded-full bg-violet-100 text-sm font-bold text-violet-700">3</span>
                    <div>
                      <p className="text-lg font-semibold text-emerald-800">Descrição do material</p>
                      <p className="text-sm text-slate-500">Escreva a descrição completa do item para manter o catálogo organizado.</p>
                    </div>
                  </div>
                  <Field label="Nome do material">
                    <Input value={stockForm.item} onChange={(e) => setStockForm((prev) => ({ ...prev, item: e.target.value }))} placeholder="Ex.: Cabo flexível 2,5 mm²" />
                  </Field>
                </div>

                <div className="rounded-[24px] border border-slate-200 bg-white p-5 space-y-4 shadow-sm">
                  <div className="flex items-center gap-3">
                    <span className="flex h-8 w-8 items-center justify-center rounded-full bg-amber-100 text-sm font-bold text-amber-700">4</span>
                    <div>
                      <p className="text-lg font-semibold text-emerald-800">Informações do material</p>
                      <p className="text-sm text-slate-500">Preencha saldo, mínimo, NF, valor e observações. Tudo isso pode ser ajustado depois.</p>
                    </div>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <Field label="Unidade">
                      <select className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-slate-900 outline-none transition focus:border-emerald-300 focus:ring-4 focus:ring-emerald-50" value={stockForm.unit} onChange={(e) => setStockForm((prev) => ({ ...prev, unit: e.target.value }))}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Field label="Nº da Nota Fiscal (NF)"><Input value={stockForm.invoice} onChange={(e) => setStockForm((prev) => ({ ...prev, invoice: e.target.value }))} placeholder="Ex.: 12345" /></Field>
                    <Field label="Observações (opcional)"><Input value={stockForm.remarks || ""} onChange={(e) => setStockForm((prev) => ({ ...prev, remarks: e.target.value }))} placeholder="Informações adicionais sobre o material..." /></Field>
                  </div>
                </div>
              </div>

              <div className="space-y-4">
                <div className="rounded-[24px] border border-emerald-200 bg-emerald-50 px-4 py-4 text-sm text-emerald-900 shadow-sm">
                  <p className="font-semibold">O grupo deve ter exatamente 3 letras.</p>
                  <p className="mt-2 text-emerald-800">Exemplos: <strong>ELE, HID, MCO</strong>.</p>
                </div>

                <div className="rounded-[24px] border border-sky-200 bg-sky-50 px-4 py-4 text-sm text-sky-900 shadow-sm">
                  <p className="font-semibold">Código informado manualmente.</p>
                  <p className="mt-2 text-sky-800">O padrão continua <strong>AAA-000</strong>, mas agora o número é preenchido manualmente.</p>
                </div>

                <div className="rounded-[24px] border border-violet-200 bg-violet-50 px-4 py-4 text-sm text-violet-900 shadow-sm">
                  <p className="font-semibold">Descrição clara facilita consulta e relatório.</p>
                  <p className="mt-2 text-violet-800">Ex.: Cabo flexível 2,5 mm², Curva 40 mm esgoto, Parafuso 3,5x25.</p>
                </div>

                <div className="rounded-[24px] border border-amber-200 bg-amber-50 px-4 py-4 text-sm text-amber-900 shadow-sm">
                  <p className="font-semibold">Os dados operacionais podem ser editados depois.</p>
                  <p className="mt-2 text-amber-800">Você pode revisar saldo, mínimo, NF e preço sempre que precisar.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-emerald-100 bg-emerald-50/60 px-4 py-3 text-sm text-emerald-900">
            <strong>Simples, rápido e padronizado.</strong> A numeração automática está desativada temporariamente para permitir correção de códigos anteriores.
          </div>

          <div className="flex justify-end gap-3">
            <Button variant="outline" onClick={() => { setStockModal(false); setStockEditModal(false); setEditingStockId(""); setStockCodeFeedback(""); }}>Cancelar</Button>
            <Button onClick={addStockItem} disabled={!obraAtual || !stockForm.code}>{stockEditModal ? "Salvar alterações" : "Salvar material"}</Button>
          </div>
        </div>
      </Modal>
        ...
        <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="max-h-72 overflow-auto rounded-2xl border border-slate-200 bg-slate-50/70 p-2 space-y-2">
                {stockPickerResults.length ? stockPickerResults.map((item) => {
                  const parsed = parseStockItemLabel(item.item || "");
                  const displayCode = item.code || parsed.code;
                  const displayDescription = item.material || parsed.description || item.item;
                  const displayQty = item.saldo ?? item.quantity ?? 0;
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between gap-3">
                        <div>
                          <p className="font-semibold text-slate-900">{displayCode ? `${displayCode} - ` : ""}{displayDescription}</p>
                          <p className="text-sm text-slate-500">{item.category || "Material"} • Saldo {formatNumberBR(displayQty, { minimumFractionDigits: 0, maximumFractionDigits: 2 })} {item.unit || "un"}{item.isCatalogOnly ? " • catálogo" : ""}</p>
                        </div>
          ...
          <div className="flex justify-end gap-3">
            ...
            <Button
              ...
              onClick={() => {
                const target = stockPickerResults.find((item) => sameId(item.id, stockPickerItemId));
                setStockPickerModal({ open: false, mode: "view" });
                if (!target) return;

                if (target.isCatalogOnly && stockPickerModal.mode === "edit") {
                  setEditingStockId("");
                  setStockForm({
                    code: target.code || "",
                    ...
                    quantity: 0,
                    min: 0,
                    category: target.category || "Material",
                    invoice: "",
                    price: 0,
                    remarks: "",
                  });
                ...
                if (stockPickerModal.mode === "edit") {
                  const realTarget = (filteredData.stock || []).find((item) => sameId(item.id, stockPickerItemId)) || target;
                  openStockEditModal(realTarget);
                } else {
      ...
      <Modal open={stockViewModal} title="Consulta de estoque" onClose={() => setStockViewModal(false)}>
        {selectedStockItem ? (() => {
          const displayCode = selectedStockItem.code || parseStockItemLabel(selectedStockItem.item || "").code || "-";
            ...
            <div className="space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="rounded-2xl border border-slate-200 bg-slate-50/70 px-4 py-3">
                  ...
                  <p className="mt-1 font-semibold text-slate-900">{displayCode}</p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-slate-50/70 px-4 py-3">
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50/70 px-4 py-3 md:col-span-2">
                  ...
                  <p className="mt-1 font-semibold text-slate-900">{displayDescription}</p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-slate-50/70 px-4 py-3">
                  <p className="text-sm text-slate-500">Saldo atual</p>
                  <p className="mt-1 text-xl font-bold text-slate-900">{displayQty} {selectedStockItem.unit}</p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-slate-50/70 px-4 py-3">
                  <p className="text-sm text-slate-500">Estoque mínimo</p>
                  <p className="mt-1 text-xl font-bold text-slate-900">{displayMin} {selectedStockItem.unit}</p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-slate-50/70 px-4 py-3">
      ...
      <Modal open={stockMovementModal} title={stockMovementForm.type === "entrada" ? "Entrada de material" : "Saída de material"} onClose={() => setStockMovementModal(false)}>
        ...
        <datalist id="stock-responsible-options">
      ...
      <Modal open={stockMovementEditModal} title="Editar movimentação" onClose={() => setStockMovementEditModal(false)}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Field label="Responsável">
            <Input list="stock-responsible-options-edit" value={stockMovementEditForm.responsible} onChange={(e) => setStockMovementEditForm((prev) => ({ ...prev, responsible: e.target.value }))} placeholder="Selecione ou digite o responsável" />
          </Field>
          <Field label="Justificativa / Destino">
            <Input value={stockMovementEditForm.note} onChange={(e) => setStockMovementEditForm((prev) => ({ ...prev, note: e.target.value }))} />
          </Field>
        </div>
        <datalist id="stock-responsible-options-edit">
          {stockResponsibleOptions.map((name) => <option key={name} value={name} />)}
        </datalist>
        <div className="mt-3 rounded-2xl border border-slate-200 bg-slate-50/70 px-4 py-3 text-sm text-slate-700">
        ...
        <div className="mt-5 flex justify-end gap-3">
          ...
          <Button onClick={saveStockMovementEdit}>Salvar edição</Button>
        </div>
      </Modal>
